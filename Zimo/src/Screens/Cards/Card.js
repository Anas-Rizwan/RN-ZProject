...
import { View, Text, ActivityIndicator, FlatList, Animated, Dimensions, SafeAreaView, StatusBar } from 'react-native';
...
const Card = () => {
    ...
    const data = state.item?.data.movies

    const AnimatedFlatList = Animated.createAnimatedComponent(FlatList);

    useEffect(() => {
        try {
            let res = dispatch(FetchMovieList())
        } catch (error) {
