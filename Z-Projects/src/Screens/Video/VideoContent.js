        ...
        <View style={styles.container}>
            ...
            <TouchableHighlight activeOpacity={1} onPress={handleclick}>
                <View style={styles.videocontainer}>
                    ...
                    <Video
                        ref={videoRef}
                        source={{ uri: 'https://static.videezy.com/system/resources/previews/000/041/561/original/MVI_3743.mp4' }}
                        resizeMode='contain'
            ...
            </TouchableHighlight>
            {
                show ?
                    ...
                    <View style={fullscreen ? styles.bottom_view_landscape : styles.bottom_view_potrait}>
                        ...
                        <View>
                            <Text style={styles.bottom_price_text}>$1,000,000</Text>
                            <Text style={fullscreen ? styles.bottom_end_text_landscape : styles.bottom_end_text_potrait}>#AB789456321</Text>
                        </View>
